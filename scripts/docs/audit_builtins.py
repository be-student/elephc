...
6. Backend availability and all 389 non-registry contract routes remain coherent.
...
def _check_backend_contracts(
    ...
    expected_counts = {
        ...
        # and the 288 functions the mysqli, PDO, web, image, OPcache, tz, var_export and
        # version preludes declare, all through injected-prelude routes.
        "prelude": 326,
